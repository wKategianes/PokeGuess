...
import './AlolaPokemon.css';

export default function AlolaPokemon({ user, setUser }) {
  ...
  const pokemonIDs = Array.from({ length: 88 }, (_, index) => index + 722);
  ...
  return (
    <>
      <h1 className='h1-title'>Alola Pokemon</h1>
      <p>Score: {score}</p>
